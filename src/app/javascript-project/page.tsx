    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 font-sans">
      <section className="bg-white rounded-lg shadow-md p-8 text-center max-w-96">
        ...
        <div className="bg-gray-100 p-4 rounded-md mb-6">
          <p className="text-xl text-gray-600">Current Count: {count}</p>
        </div>

        <div className="flex justify-between space-x-2 mb-4">
          <button
            onClick={handleIncrease}
            className="flex-1 text-md bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition-colors"
          >
            Increase
          </button>

            ...
            <section className="bg-white shadow-md rounded-lg p-6 mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-blue-100 p-4 rounded-lg text-center skill-card">
                  <h3 className="font-semibold text-sm text-gray-800">HTML</h3>
                  <p className="text-xs text-gray-600">Markup Language</p>
                  <div className="mt-2">
                ...
                <div className="bg-green-100 p-4 rounded-lg text-center skill-card">
                  <h3 className="font-semibold text-sm text-gray-800">CSS</h3>
                  <p className="text-xs text-gray-600">Styling Techniques</p>
                  <div className="mt-2">
                ...
                <div className="bg-purple-100 p-4 rounded-lg text-center skill-card">
                  ...
                  <p className="text-xs text-gray-600">Mobile-First Approach</p>
                  <div className="mt-2">
            ...
            <section className="bg-white shadow-md rounded-lg p-6 mt-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label
                    htmlFor="name"
                    className="text-[0.8rem] block mb-2 text-gray-700"
                  >
                    Name
                  </label>
                  <input
                    type="text"
                    id="name"
                    className="text-[0.8rem] w-full text-gray-600 p-2 border rounded-md"
                ...
                <div>
                  ...
                  <input
                    type="email"
                    id="email"
                    className="text-[0.8rem] w-full p-2 border text-gray-600 rounded-md"
                ...
                <button
                  type="submit"
                  className="bg-blue-500 text-[0.8rem] text-white px-4 py-2 rounded-md hover:bg-blue-600"
                >
                  Send Message
                </button>
              </form>
